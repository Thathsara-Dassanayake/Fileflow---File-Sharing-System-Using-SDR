...
class image_trans(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "image_trans")
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_char*1, '/home/shevi/Documents/image_trans.py', False, 0, 0)
        self.blocks_file_source_0.set_begin_tag(pmt.PMT_NIL)
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, 'C:\\Users\\javin\\Downloads\\Testing\\rx.txt', False)
...
def main(top_block_cls=image_trans, options=None):
