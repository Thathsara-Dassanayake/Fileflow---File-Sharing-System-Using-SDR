...
class text(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Text", catch_exceptions=True)
        ...
        self.settings = Qt.QSettings("GNU Radio", "text")
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_char*1, '/home/shevi/Documents/GNU radio/texts/text', False, 0, 0)
        self.blocks_file_source_0.set_begin_tag(pmt.PMT_NIL)
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, 'C:\\Users\\receiver.txt', False)
        ...
        self.connect((self.blocks_throttle_0_0_0, 0), (self.blocks_stream_to_tagged_stream_0, 0))
...
def main(top_block_cls=text, options=None):
