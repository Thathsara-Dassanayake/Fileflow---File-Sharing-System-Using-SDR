...
class fmtransmitter(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_wavfile_source_0 = blocks.wavfile_source('/home/shevi/Downloads/champion-80bpm-132686.wav', True)
        ...
        self.connect((self.blocks_multiply_const_vxx_0_0, 0), (self.soapy_bladerf_sink_0, 0))
