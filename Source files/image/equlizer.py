...
class equlizer(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Equlizer", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Equlizer")
        ...
        self.settings = Qt.QSettings("GNU Radio", "equlizer")
        ...
        self._time_offset_win = RangeWidget(self._time_offset_range, self.set_time_offset, "channel time offset", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self._freq_offset_win = RangeWidget(self._freq_offset_range, self.set_freq_offset, "channel frequncy offset", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self.tab.addTab(self.tab_widget_0, 'channel')
        self.tab_widget_1 = Qt.QWidget()
        self.tab_layout_1 = Qt.QBoxLayout(Qt.QBoxLayout.TopToBottom, self.tab_widget_1)
        self.tab_grid_layout_1 = Qt.QGridLayout()
        self.tab_layout_1.addLayout(self.tab_grid_layout_1)
        self.tab.addTab(self.tab_widget_1, 'timing')
        self.tab_widget_2 = Qt.QWidget()
        self.tab_layout_2 = Qt.QBoxLayout(Qt.QBoxLayout.TopToBottom, self.tab_widget_2)
        self.tab_grid_layout_2 = Qt.QGridLayout()
        self.tab_layout_2.addLayout(self.tab_grid_layout_2)
        self.tab.addTab(self.tab_widget_2, 'equlizer')
        ...
        self._eq_gain_win = RangeWidget(self._eq_gain_range, self.set_eq_gain, "equlizer rate", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._eq_gain_win)
        self.digital_pfb_clock_sync_xxx_0 = digital.pfb_clock_sync_ccf(4.004, timing_loop_bw, rrc_taps, nfilts, 16, 1.5, 1)
        self.digital_linear_equalizer_0 = digital.linear_equalizer(11, 2, variable_adaptive_algorithm_0, True, [ ], 'corr_est')
        ...
        self.connect((self.digital_linear_equalizer_0, 0), (self.qtgui_freq_sink_x_0_0_0, 0))
...
def main(top_block_cls=equlizer, options=None):
