...
class timing(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Timing", catch_exceptions=True)
        ...
        self.settings = Qt.QSettings("GNU Radio", "timing")
...
def main(top_block_cls=timing, options=None):
