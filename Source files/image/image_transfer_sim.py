...
import image_transfer_sim_epy_block_0 as epy_block_0  # embedded python block
import image_transfer_sim_epy_block_1 as epy_block_1  # embedded python block



from gnuradio import qtgui

class image_transfer_sim(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Image Transfer Sim", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Image Transfer Sim")
        ...
        self.settings = Qt.QSettings("GNU Radio", "image_transfer_sim")
        ...
        for c in range(1, 2):
            self.controls_grid_layout_1.setColumnStretch(c, 1)
        self.epy_block_1 = epy_block_1.enc_blk(key=1)
        self.epy_block_0 = epy_block_0.dec_blk(key=1)
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_char*1, '/home/shevi/Documents/GNU radio/image/Untitled.jpeg', False, 0, 0)
        self.blocks_file_source_0.set_begin_tag(pmt.PMT_NIL)
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, 'C:\\Users\\receiver.jpg', False)
        ...
        self.connect((self.blocks_throttle_0_0_0, 0), (self.epy_block_1, 0))
        ...
        self.connect((self.epy_block_1, 0), (self.blocks_stream_to_tagged_stream_0, 0))
...
def main(top_block_cls=image_transfer_sim, options=None):
