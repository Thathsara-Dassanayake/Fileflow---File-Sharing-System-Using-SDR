...
class image_transfer_TX(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "image_transfer_TX")
        ...
        self.controls.addTab(self.controls_widget_0, 'outputs')
        self.controls_widget_1 = Qt.QWidget()
        self.controls_layout_1 = Qt.QBoxLayout(Qt.QBoxLayout.TopToBottom, self.controls_widget_1)
        self.controls_grid_layout_1 = Qt.QGridLayout()
        self.controls_layout_1.addLayout(self.controls_grid_layout_1)
        self.controls.addTab(self.controls_widget_1, 'byte stream')
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_char*1, '/home/shevi/Documents/Untitled.jpeg', True, 0, 0)
...
def main(top_block_cls=image_transfer_TX, options=None):
