...
class image_transfer_RX(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "image_transfer_RX")
        ...
        self.timing_loop_bw = timing_loop_bw = 0.15
        self.samp_rate = samp_rate = 1024000
        self.rrc_taps = rrc_taps = firdes.root_raised_cosine(nfilts, nfilts, 1.0/float(sps), 0.35, 11*sps*nfilts)
        self.psk_order = psk_order = 4
        self.phase_bw = phase_bw = 6.00/100.0
        ...
        self.controls.addTab(self.controls_widget_0, 'input')
        self.controls_widget_1 = Qt.QWidget()
        self.controls_layout_1 = Qt.QBoxLayout(Qt.QBoxLayout.TopToBottom, self.controls_widget_1)
        self.controls_grid_layout_1 = Qt.QGridLayout()
        self.controls_layout_1.addLayout(self.controls_grid_layout_1)
        self.controls.addTab(self.controls_widget_1, 'timing')
        ...
        self.controls.addTab(self.controls_widget_2, 'equlizer')
        ...
        self.controls.addTab(self.controls_widget_3, 'frequncy correction')
        ...
        self.controls.addTab(self.controls_widget_4, 'receive byte strem')
        self.top_grid_layout.addWidget(self.controls, 0, 0, 1, 2)
        for r in range(0, 1):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(0, 2):
            self.top_grid_layout.setColumnStretch(c, 1)
        self._timing_loop_bw_range = Range(0.0, 0.2, 0.01, 0.15, 200)
        ...
        self._phase_bw_range = Range(0.0, 1.0, 0.01, 6.00/100.0, 200)
    ...
    def get_psk_order(self):
        return self.psk_order

    def set_psk_order(self, psk_order):
        self.psk_order = psk_order
...
def main(top_block_cls=image_transfer_RX, options=None):
